...
parser.add_argument('--train_dir', default='/ccvl/net/ccvl15/zzhou82/PublicAbdominalData/', type=str)
parser.add_argument('--val_dir', default='/ccvl/net/ccvl15/zzhou82/PublicAbdominalData/', type=str)
