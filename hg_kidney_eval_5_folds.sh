...
if [ $1 == 'eval.aug_kidney_0.no_pretrain.unet' ]; then

    python -W ignore validation.py --model=unet --val_overlap=0.75 --val_dir $datapath --json_dir datafolds/5_fold/kidney/kidney_tumor_0.json --log_dir runs_kidney/aug_kidney_0.no_pretrain.unet --save_dir out/kidney

elif [ $1 == 'eval.aug_kidney_0.pretrain.swin_unetrv2_base' ]; then

    python -W ignore validation.py --model=swin_unetrv2 --swin_type=base --val_overlap=0.75 --val_dir $datapath --json_dir datafolds/5_fold/kidney/kidney_tumor_0.json --log_dir runs_kidney/aug_kidney_0.pretrain.swin_unetrv2_base --save_dir out/kidney

elif [ $1 == 'eval.aug_kidney_0.no_pretrain.swin_unetrv2_base' ]; then

    python -W ignore validation.py --model=swin_unetrv2 --swin_type=base --val_overlap=0.75 --val_dir $datapath --json_dir datafolds/5_fold/kidney/kidney_tumor_0.json --log_dir runs_kidney/aug_kidney_0.no_pretrain.swin_unetrv2_base --save_dir out/kidney

elif [ $1 == 'eval.aug_kidney_0.no_pretrain.swin_unetrv2_small' ]; then

    python -W ignore validation.py --model=swin_unetrv2 --swin_type=small --val_overlap=0.75 --val_dir $datapath --json_dir datafolds/5_fold/kidney/kidney_tumor_0.json --log_dir runs_kidney/aug_kidney_0.no_pretrain.swin_unetrv2_small --save_dir out/kidney

elif [ $1 == 'eval.aug_kidney_0.no_pretrain.swin_unetrv2_tiny' ]; then

    python -W ignore validation.py --model=swin_unetrv2 --swin_type=tiny --val_overlap=0.75 --val_dir $datapath --json_dir datafolds/5_fold/kidney/kidney_tumor_0.json --log_dir runs_kidney/aug_kidney_0.no_pretrain.swin_unetrv2_tiny --save_dir out/kidney

elif [ $1 == 'eval.aug_kidney_1.no_pretrain.unet' ]; then

    python -W ignore validation.py --model=unet --val_overlap=0.75 --val_dir $datapath --json_dir datafolds/5_fold/kidney/kidney_tumor_1.json --log_dir runs_kidney/aug_kidney_1.no_pretrain.unet --save_dir out/kidney

elif [ $1 == 'eval.aug_kidney_1.pretrain.swin_unetrv2_base' ]; then

    python -W ignore validation.py --model=swin_unetrv2 --swin_type=base --val_overlap=0.75 --val_dir $datapath --json_dir datafolds/5_fold/kidney/kidney_tumor_1.json --log_dir runs_kidney/aug_kidney_1.pretrain.swin_unetrv2_base --save_dir out/kidney

elif [ $1 == 'eval.aug_kidney_1.no_pretrain.swin_unetrv2_base' ]; then

    python -W ignore validation.py --model=swin_unetrv2 --swin_type=base --val_overlap=0.75 --val_dir $datapath --json_dir datafolds/5_fold/kidney/kidney_tumor_1.json --log_dir runs_kidney/aug_kidney_1.no_pretrain.swin_unetrv2_base --save_dir out/kidney

elif [ $1 == 'eval.aug_kidney_1.no_pretrain.swin_unetrv2_small' ]; then

    python -W ignore validation.py --model=swin_unetrv2 --swin_type=small --val_overlap=0.75 --val_dir $datapath --json_dir datafolds/5_fold/kidney/kidney_tumor_1.json --log_dir runs_kidney/aug_kidney_1.no_pretrain.swin_unetrv2_small --save_dir out/kidney

elif [ $1 == 'eval.aug_kidney_1.no_pretrain.swin_unetrv2_tiny' ]; then

    python -W ignore validation.py --model=swin_unetrv2 --swin_type=tiny --val_overlap=0.75 --val_dir $datapath --json_dir datafolds/5_fold/kidney/kidney_tumor_1.json --log_dir runs_kidney/aug_kidney_1.no_pretrain.swin_unetrv2_tiny --save_dir out/kidney

elif [ $1 == 'eval.aug_kidney_2.no_pretrain.unet' ]; then

    python -W ignore validation.py --model=unet --val_overlap=0.75 --val_dir $datapath --json_dir datafolds/5_fold/kidney/kidney_tumor_2.json --log_dir runs_kidney/aug_kidney_2.no_pretrain.unet --save_dir out/kidney

elif [ $1 == 'eval.aug_kidney_2.pretrain.swin_unetrv2_base' ]; then

    python -W ignore validation.py --model=swin_unetrv2 --swin_type=base --val_overlap=0.75 --val_dir $datapath --json_dir datafolds/5_fold/kidney/kidney_tumor_2.json --log_dir runs_kidney/aug_kidney_2.pretrain.swin_unetrv2_base --save_dir out/kidney

elif [ $1 == 'eval.aug_kidney_2.no_pretrain.swin_unetrv2_base' ]; then

    python -W ignore validation.py --model=swin_unetrv2 --swin_type=base --val_overlap=0.75 --val_dir $datapath --json_dir datafolds/5_fold/kidney/kidney_tumor_2.json --log_dir runs_kidney/aug_kidney_2.no_pretrain.swin_unetrv2_base --save_dir out/kidney

elif [ $1 == 'eval.aug_kidney_2.no_pretrain.swin_unetrv2_small' ]; then

    python -W ignore validation.py --model=swin_unetrv2 --swin_type=small --val_overlap=0.75 --val_dir $datapath --json_dir datafolds/5_fold/kidney/kidney_tumor_2.json --log_dir runs_kidney/aug_kidney_2.no_pretrain.swin_unetrv2_small --save_dir out/kidney

elif [ $1 == 'eval.aug_kidney_2.no_pretrain.swin_unetrv2_tiny' ]; then

    python -W ignore validation.py --model=swin_unetrv2 --swin_type=tiny --val_overlap=0.75 --val_dir $datapath --json_dir datafolds/5_fold/kidney/kidney_tumor_2.json --log_dir runs_kidney/aug_kidney_2.no_pretrain.swin_unetrv2_tiny --save_dir out/kidney

elif [ $1 == 'eval.aug_kidney_3.no_pretrain.unet' ]; then

    python -W ignore validation.py --model=unet --val_overlap=0.75 --val_dir $datapath --json_dir datafolds/5_fold/kidney/kidney_tumor_3.json --log_dir runs_kidney/aug_kidney_3.no_pretrain.unet --save_dir out/kidney

elif [ $1 == 'eval.aug_kidney_3.pretrain.swin_unetrv2_base' ]; then

    python -W ignore validation.py --model=swin_unetrv2 --swin_type=base --val_overlap=0.75 --val_dir $datapath --json_dir datafolds/5_fold/kidney/kidney_tumor_3.json --log_dir runs_kidney/aug_kidney_3.pretrain.swin_unetrv2_base --save_dir out/kidney

elif [ $1 == 'eval.aug_kidney_3.no_pretrain.swin_unetrv2_base' ]; then

    python -W ignore validation.py --model=swin_unetrv2 --swin_type=base --val_overlap=0.75 --val_dir $datapath --json_dir datafolds/5_fold/kidney/kidney_tumor_3.json --log_dir runs_kidney/aug_kidney_3.no_pretrain.swin_unetrv2_base --save_dir out/kidney

elif [ $1 == 'eval.aug_kidney_3.no_pretrain.swin_unetrv2_small' ]; then

    python -W ignore validation.py --model=swin_unetrv2 --swin_type=small --val_overlap=0.75 --val_dir $datapath --json_dir datafolds/5_fold/kidney/kidney_tumor_3.json --log_dir runs_kidney/aug_kidney_3.no_pretrain.swin_unetrv2_small --save_dir out/kidney

elif [ $1 == 'eval.aug_kidney_3.no_pretrain.swin_unetrv2_tiny' ]; then

    python -W ignore validation.py --model=swin_unetrv2 --swin_type=tiny --val_overlap=0.75 --val_dir $datapath --json_dir datafolds/5_fold/kidney/kidney_tumor_3.json --log_dir runs_kidney/aug_kidney_3.no_pretrain.swin_unetrv2_tiny --save_dir out/kidney

elif [ $1 == 'eval.aug_kidney_4.no_pretrain.unet' ]; then

    python -W ignore validation.py --model=unet --val_overlap=0.75 --val_dir $datapath --json_dir datafolds/5_fold/kidney/kidney_tumor_4.json --log_dir runs_kidney/aug_kidney_4.no_pretrain.unet --save_dir out/kidney

elif [ $1 == 'eval.aug_kidney_4.pretrain.swin_unetrv2_base' ]; then

    python -W ignore validation.py --model=swin_unetrv2 --swin_type=base --val_overlap=0.75 --val_dir $datapath --json_dir datafolds/5_fold/kidney/kidney_tumor_4.json --log_dir runs_kidney/aug_kidney_4.pretrain.swin_unetrv2_base --save_dir out/kidney

elif [ $1 == 'eval.aug_kidney_4.no_pretrain.swin_unetrv2_base' ]; then

    python -W ignore validation.py --model=swin_unetrv2 --swin_type=base --val_overlap=0.75 --val_dir $datapath --json_dir datafolds/5_fold/kidney/kidney_tumor_4.json --log_dir runs_kidney/aug_kidney_4.no_pretrain.swin_unetrv2_base --save_dir out/kidney

elif [ $1 == 'eval.aug_kidney_4.no_pretrain.swin_unetrv2_small' ]; then

    python -W ignore validation.py --model=swin_unetrv2 --swin_type=small --val_overlap=0.75 --val_dir $datapath --json_dir datafolds/5_fold/kidney/kidney_tumor_4.json --log_dir runs_kidney/aug_kidney_4.no_pretrain.swin_unetrv2_small --save_dir out/kidney

elif [ $1 == 'eval.aug_kidney_4.no_pretrain.swin_unetrv2_tiny' ]; then

    python -W ignore validation.py --model=swin_unetrv2 --swin_type=tiny --val_overlap=0.75 --val_dir $datapath --json_dir datafolds/5_fold/kidney/kidney_tumor_4.json --log_dir runs_kidney/aug_kidney_4.no_pretrain.swin_unetrv2_tiny --save_dir out/kidney   
